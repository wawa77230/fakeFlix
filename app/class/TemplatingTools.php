...
class TemplatingTools
{
     ...
     * @throws Exception
     */
    protected function addImage($file, $dir): string
    {
        if (empty($file['name']))
    ...
    protected function flashBag($type, $message, $action = null): array
    {
    ...
    protected function cleanLink($iframe)
    {
        ...
        $firstLetters = substr($iframe, 0, 5);
    ...
    protected function switch($value): int
    {
